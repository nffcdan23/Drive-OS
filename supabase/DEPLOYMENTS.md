...
| 2026-09-23 | staging (existing project) | 0001–0015 | new `[deploy supabase-staging]` commit after the rollback-only Storage policy proof passed on staging, approved by project owner | see the "Supabase staging deploy" run for this commit in GitHub Actions |
