...
const TEXT_PRIMARY = palette.dark.foreground;
const TEXT_SECONDARY = palette.dark.mutedForeground;
const TRACK_COLOR = palette.dark.border;
const CARD_SHADOW = {
  shadowColor: "#000",
    ...
    <View style={styles.speedoWrapper}>
      <Svg width={152} height={152} viewBox="0 0 200 200">
        ...
        {tickFracs.map((frac) => {
          ...
          const dp = {
            x: CX + DOT_R * Math.cos(toRad(deg)),
            y: CY + DOT_R * Math.sin(toRad(deg)),
          };
          ...
          return (
            <Circle
              ...
              cy={dp.y}
              r={2.8}
              fill={active ? ORANGE : palette.dark.border}
            />
          );
        })}
      </Svg>
          ...
          <View style={styles.gpsBars}>
            {[1, 2, 3, 4].map((i) => (
              <View
                ...
                style={[
                  styles.gpsBar,
                  { height: 4 + i * 3, backgroundColor: barColor(i) },
                ]}
              />
            ))}
          </View>
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flexDirection: "row", alignItems: "baseline", gap: 6 }}>
          <Text style={styles.navDistance}>
            {Math.round(instruction.distanceMetres)} m
          </Text>
        </View>
...
export default function ActiveDriveOverlay({
  ...
  const handleEndDrive = useCallback(() => {
    Alert.alert("End Drive?", "This will finalise and save your journey.", [
    ...
    >
        ...
        >
          ...
          <GlassSurface style={[styles.statusCard, styles.driveStatusCard]}>
            ...
            <View>
              ...
              <Text style={styles.driveStatusTimer}>
      ...
      >
        ...
        <TouchableOpacity
          ...
          accessibilityState={{ expanded: showTelemetry }}
        ...
        >
          ...
          >
            {showTelemetry ? "Hide drive statistics" : "Drive statistics"}
          </Text>
          <Ionicons
            name={showTelemetry ? "chevron-down" : "chevron-up"}
            color={TEXT_SECONDARY}
            size={16}
          />
        </TouchableOpacity>
        ...
        <View style={styles.controlsRow}>
          ...
          >
            <Ionicons
              name={saveConfirm ? "checkmark" : "bookmark-outline"}
              size={22}
